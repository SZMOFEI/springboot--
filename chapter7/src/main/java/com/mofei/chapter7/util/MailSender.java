package com.mofei.chapter7.util;

import com.mofei.chapter7.domain.MailEntity;
...
public class MailSender {
    ...
    public void send() throws Exception {
        ...
        //3.3循环邮件地址去发送邮件
        List<String> targets = mail.getAddressList();
